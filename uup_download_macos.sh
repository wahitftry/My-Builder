#!/bin/bash
#Generated on 2023-10-12 04:13:16 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://www.uup.ee/get.php?id=ba57f572-7e76-48f9-92c8-7724bbea018d&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
